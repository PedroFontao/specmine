...
#'
#' Package-level imports for specmine.
#'
#' @keywords internal
...
#' @importFrom stats IQR TukeyHSD aggregate approx as.dendrogram aov convolve
...
#' @importFrom stats p.adjust predict prcomp quantile reformulate sd spline
