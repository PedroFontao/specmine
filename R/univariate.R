...
#' @param x.val Variable name or x value to test.
...
#'
#' @param dataset Dataset to analyze.
#' @param column.class Metadata column used to define groups.
#' @param doTukey Logical. If TRUE, also performs TukeyHSD post-hoc test.
#' @param write.file Logical. If TRUE, writes results to file.
#' @param file.out Output file name.
#'
